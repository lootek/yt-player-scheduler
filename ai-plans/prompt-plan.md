...
first, figure out what the service in ~/projects/lootek/yt-player-scheduler does at bfe645af23127578dea7ee3f1caf3ae98f19442b (NOT on HEAD!).
mind, it is deployed at pi@ithilien in ~/yt-daily-player/ (feel free to ssh into there), yet in some newer version - ignore that and focus on the exact revision I gave you 
...
When done, copy the resulting plan to an .md file named after your model to here.
